...
class ActividadPrevia(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ActividadPrevia")
        ...
        # Blocks
        ##################################################
        self._EbN0_range = Range(0, 100, 1, 2, -100)
        self._EbN0_win = RangeWidget(self._EbN0_range, self.set_EbN0, "Eb / N0 (dB)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.fec_ber_bf_0 = fec.ber_bf(False, 10, -7)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/felipe/workspace/ComunicacionesDigitales/LAB4/salida2', False)
...
def main(top_block_cls=ActividadPrevia, options=None):
