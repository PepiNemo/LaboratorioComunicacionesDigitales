...
class Act1Lab3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Act1Lab3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Act1Lab3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Act1Lab3")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 500e4
        self.R = R = 10e3 * 2
        self.fc2 = fc2 = R*20/2
        self.fc = fc = R*10/2
        self.LongitudVector = LongitudVector = int((samp_rate//R)*3)
        ...
        self.qtgui_time_sink_x_0_1_0_0 = qtgui.time_sink_f(
            LongitudVector, #size
            samp_rate, #samp_rate
            'Señal modulante m(t), tren de pulsos con periodo T=2/R = 1e-4 (s)', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_1_0 = qtgui.time_sink_f(
            LongitudVector, #size
            samp_rate, #samp_rate
            'coseno Fc = 100k(Hz) => Tc = 1e-5(s)', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_f(
            LongitudVector, #size
            samp_rate, #samp_rate
            'Coseno fc2 = 200k(Hz) => Tc2 = 5e-6 (s)', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, R/2, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc2, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.qtgui_time_sink_x_0_1_0_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_0_1_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_LongitudVector(int((self.samp_rate//self.R)*3))
    ...
    def set_R(self, R):
        self.R = R
        self.set_LongitudVector(int((self.samp_rate//self.R)*3))
        self.set_fc(self.R*10/2)
        self.set_fc2(self.R*20/2)
        self.analog_sig_source_x_0_0_0_0.set_frequency(self.R/2)
    ...
    def set_fc2(self, fc2):
        self.fc2 = fc2
        self.analog_sig_source_x_0.set_frequency(self.fc2)
    ...
    def get_LongitudVector(self):
        return self.LongitudVector

    def set_LongitudVector(self, LongitudVector):
        self.LongitudVector = LongitudVector




def main(top_block_cls=Act1Lab3, options=None):
