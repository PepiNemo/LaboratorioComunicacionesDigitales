...
figure(2)
subplot(2,3,1); plot(t1a,mt1a,'-o'); title('Señal analogica'); xlabel('t (segundos)'); ylabel('amplitud');
subplot(2,3,2); plot(f1a,magTF1a,'-o'); title('Transformada Fourier analogica'); xlabel('f (hz)'); 
